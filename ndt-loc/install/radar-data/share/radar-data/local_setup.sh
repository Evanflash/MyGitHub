...
: ${AMENT_CURRENT_PREFIX:="/home/evan/code/ndt-loc/install/radar-data"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/radar-data/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/radar-data/environment/path.sh"
